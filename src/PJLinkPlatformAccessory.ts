import type {API, Service, PlatformAccessory, Logger} from 'homebridge';
...
export class PJLinkPlatformAccessory {
  ...
  public constructor(
    ...
    // handlers
    this.tvHandler = new TelevisionHandler(
      this.log,
      this.api,
      this.accessory,
      this.device,
    ...
    this.informationHandler = new InformationHandler(
      this.log,
      this.api,
      this.accessory,
      this.device,
    ...
    this.inputsHandler = new InputSourceHandler(
      this.log,
      this.api,
      this.accessory,
      this.device,
    ...
    if (this.enableSpeaker) {
      this.speakerHandler = new TelevisionSpeakerHandler(
        this.log,
        this.api,
        this.accessory,
        this.device,
